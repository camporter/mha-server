...
public interface StreamInterface {
	...
	/**
	 * Skips to the next entry in the current stream. e.g. Skip to the next song
	 * in a playlist.
	 * 
	 * @return True on success.
	 */
	...
	/**
	 * Skips to the previous entry in the current stream. e.g. Skip to the
	 * previous song in a playlist.
	 * 
	 * @return
	 */
	public boolean prev();
