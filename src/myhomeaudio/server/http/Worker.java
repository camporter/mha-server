...
public class Worker extends Thread {
	...
	public Worker() {
		...
		this.httpService = new HttpService(httpProcessor, new DefaultConnectionReuseStrategy(),
				new DefaultHttpResponseFactory(), httpRequestReqistry, this.params);
	}
	 ...
	 * /node/list <- NodeHelper /song/list <- SongHelper
	 * 
	 * @param helperName Name of the Helper class required to handle the request
	 * 
	 * @return Helper Returns the specified Helper class
	 */
